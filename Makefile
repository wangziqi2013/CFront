...
OBJ_FILES=./build/main.o ./build/lex.o ./build/test_suite.o ./build/lex_test.o ./build/token.o ./build/syntax.o ./build/syntax_test.o ./build/type.o
...
./build/type.o: $(SRC)
	$(CXX) ./src/type.cpp -c -o ./build/type.o $(CXX_FLAGS)
